...
<html lang="en">
  ...
  <body>
    ...
    <div id="registerModal" class="modal">
      <div class="modal-content">
        <span class="close-btn" onclick="closeModal('registerModal')"
          >&times;</span
        >
    ...
    <section class="hero" id="home">
      <div class="hero-content">
        ...
        <p>
          Your generosity today creates a better tomorrow. Join us in bringing
          hope, help, and positive change to those who need it most.
        </p>
    ...
    <section class="section" id="about">
      ...
      <div class="cards-container">
        <div class="card">
          ...
          <h3>Our Mission</h3>
          <p>
            Dedicated to creating lasting change through sustainable development
        ...
        <div class="card">
          ...
          <h3>Transparency</h3>
          <p>
            100% transparency in how your donations are used, with regular
        ...
        <div class="card">
          ...
          <h3>Global Impact</h3>
          <p>
            Creating positive change across communities worldwide through
            focused initiatives.
          </p>
        </div>
      </div>
    ...
    <section class="section" id="causes">
      ...
      <div class="cards-container">
        ...
        <div class="card">
          ...
          <h3>Environment</h3>
          <p>
            Working towards a sustainable future through environmental
            conservation.
          </p>
        </div>
      </div>
    ...
    <footer class="footer">
      <div class="footer-content">
        <div class="footer-section">
          <h4>About Us</h4>
          <p>
            NGO Donation is committed to making a positive impact through
